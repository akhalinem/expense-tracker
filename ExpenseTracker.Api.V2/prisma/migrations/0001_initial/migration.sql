...
-- CreateTable
CREATE TABLE "public"."sync_performance_stats" (
    "id" BIGSERIAL NOT NULL,
    "user_id" UUID NOT NULL,
    ...
    CONSTRAINT "sync_performance_stats_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_categories_user_updated" ON "public"."categories"("user_id", "updated_at" DESC);
...
-- CreateIndex
CREATE INDEX "idx_transactions_user_sync_lookup" ON "public"."transactions"("user_id", "amount", "date", "type");

-- CreateIndex
CREATE INDEX "idx_transactions_user_updated" ON "public"."transactions"("user_id", "updated_at" DESC);
...
-- CreateIndex
CREATE INDEX "idx_sync_jobs_user_created" ON "public"."sync_jobs"("user_id", "created_at" DESC);
...
-- CreateIndex
CREATE INDEX "idx_sync_performance_operation_created" ON "public"."sync_performance_stats"("operation_type", "created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_sync_performance_user_created" ON "public"."sync_performance_stats"("user_id", "created_at" DESC);
...
-- AddForeignKey
ALTER TABLE "public"."transactions" ADD CONSTRAINT "transactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."transaction_categories" ADD CONSTRAINT "transaction_categories_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."transaction_categories" ADD CONSTRAINT "transaction_categories_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."voice_recordings" ADD CONSTRAINT "voice_recordings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "public"."sync_jobs" ADD CONSTRAINT "sync_jobs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
