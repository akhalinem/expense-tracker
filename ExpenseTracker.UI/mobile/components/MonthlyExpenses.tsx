...
export default function MonthlyExpenses({ month, year }: MonthlyExpensesProps) {
    ...
    const expensesQuery = useQuery({
        queryKey: ['expenses', { categories: Array.from(categoriesToggle.selected), month, year, }],
        queryFn: () => expensesService.getExpenses(Array.from(categoriesToggle.selected), month, year),
        placeholderData: keepPreviousData
    });

    const budgetQuery = useQuery({
        queryKey: ['budgets', 'monthly', { month, year }],
        queryFn: () => budgetsService.getMonthlyBudget(month, year),
        placeholderData: keepPreviousData
    });
